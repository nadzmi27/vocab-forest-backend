...
Deno.serve(async (req) => {
  switch (req.method) {
    ...
    // e.g. http://localhost:8000/?word=bank or http://localhost:8000/?word=dog&save=true to save in word-example
    case "GET": {
      ...
      const urlToFetch = `https://freedictionaryapi.com/api/v1/entries/en/${word}`; // Dictionary api endpoint
